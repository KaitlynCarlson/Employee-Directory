...
class Directory extends React.Component {
  ...
  handleDOBStartInput = (event) => {
    event.preventDefault();
    const value = event.target.value;
    this.setState({ startDate: value });
  };
  handleDOBEndInput = (event) => {
    event.preventDefault();
    const value = event.target.value;
    ...
    return (
      <div>
        <div className="container">
          ...
          <p id="description">
            Search employees by date of birth or name to quickly access employee
            data.
          </p>
          <div className="container">
            <DOBSearch
              handleDOBStartInput={this.handleDOBStartInput}
              handleDOBEndInput={this.handleDOBEndInput}
            />
